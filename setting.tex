...
\geometry{bottom=3cm,left=2.5cm,right=2.5cm,top=3cm}
...
\titleformat{\section}{\Large\sffamily\bfseries}{\arabic{section}\hsp\textcolor{PKUred}{\vrule width 2pt}\hsp}{0pt}{}
