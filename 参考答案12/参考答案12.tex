...
\begin{equation}
	\begin{aligned}
		...
		=                                                                                & \left.\int_{0}^{1}\left(\sqrt{\frac{x}{2}} 2 \sqrt{y}+\sqrt{\frac{1}{2 x}} \frac{2}{3} y^{\frac{3}{2}}\right)\right|_{1- x} ^{1} \\
...
\end{equation}
\begin{align}
	S_{1} & =\iint_{D} \sqrt{1+ z_x^{2}+z_{y}^{2}} \dif x \dif y=2 \iint_{D} \dif x \dif y        \\
	S_{2} & = \iint_{D} \sqrt{1+ z_x^{2}+z_{y}^{2}}\dif x \dif y=\sqrt{3} \iint_{D} \dif x \dif y
\end{align}
做变量替换
\begin{equation}
